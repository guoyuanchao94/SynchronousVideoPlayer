...
Q_CONSTINIT static const qt_meta_stringdata_CLASSServerENDCLASS_t qt_meta_stringdata_CLASSServerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 12),  // "addUdpClient"
        QT_MOC_LITERAL(20, 0),  // ""
        QT_MOC_LITERAL(21, 11),  // "QTcpSocket*"
        QT_MOC_LITERAL(33, 6),  // "client"
        QT_MOC_LITERAL(40, 12),  // "QHostAddress"
        QT_MOC_LITERAL(53, 2),  // "ip"
        QT_MOC_LITERAL(56, 7),  // "udpPort"
        QT_MOC_LITERAL(64, 15),  // "removeUdpClient"
        QT_MOC_LITERAL(80, 10),  // "initServer"
        QT_MOC_LITERAL(91, 4),  // "port"
        QT_MOC_LITERAL(96, 13),  // "newConnection"
        QT_MOC_LITERAL(110, 18),  // "clientDisconnected"
        QT_MOC_LITERAL(129, 14)   // "readFromClient"
    },
    "Server",
    "addUdpClient",
    "",
...
void Server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->readFromClient(); break;
        default: ;
        }
        ...
        {
            using _t = void (Server::*)(QTcpSocket * , QHostAddress , quint16 );
            if (_t _q_method = &Server::addUdpClient; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &Server::removeUdpClient; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Server::addUdpClient(QTcpSocket * _t1, QHostAddress _t2, quint16 _t3)
{
...
// SIGNAL 1
void Server::removeUdpClient(QTcpSocket * _t1)
{
